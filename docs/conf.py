...
# -*- coding: utf-8 -*-
#
# SecureDrop Workstation documentation build configuration file, created by
...
htmlhelp_basename = 'SecureDropWorkstationdoc'
...
latex_documents = [
    (master_doc, 'SecureDropWorkstation.tex', 'SecureDrop Workstation Documentation',
     'SecureDrop', 'manual'),
]
...
man_pages = [
    (master_doc, 'securedropworkstation', 'SecureDrop Workstation Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'SecureDropWorkstation', 'SecureDrop Workstation Documentation',
     author, 'SecureDropWorkstation', 'One line description of project.',
     'Miscellaneous'),
]
