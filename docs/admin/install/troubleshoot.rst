...
- Open a ``dom0`` terminal via |qubes_menu| **▸ Gear Icon (left-hand side) ▸ Other Tools ▸ Xfce Terminal**. Once the Terminal window opens, run the following command to list the SVS submission key details, including its fingerprint:
...
Open a ``dom0`` terminal via |qubes_menu| **▸ Gear Icon (left-hand side) ▸ Other Tools ▸ Xfce Terminal**, and run the following command to list the devices connected to the ``sys-net`` VM.
...
Once Qubes has started and you have logged in, open a ``dom0`` terminal via |qubes_menu| **▸ Gear Icon (left-hand side) ▸ Other Tools ▸ Xfce Terminal** and type
